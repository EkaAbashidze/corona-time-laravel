 ...
 <div class="text-start flex flex-col items-start justify-center h-screen">
  ...
  <form method="POST" action="reset">
    ...
    <div class="mt-4">
      ...
      <input type="email" name="email" id="email" placeholder="Enter your email" class="block h-[56px] w-[390px] mt-2 px-4 py-2 rounded-md bg-white border border-gray-300 {{ $errors->has('email') ? 'border-red-500' : 'border-gray-300' }}" value="{{ old('email') }}" required autocomplete="email">
    </div>
    @error('email')
