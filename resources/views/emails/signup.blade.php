<x-mail::message>
    ...
    <x-mail::button :url="route('confirmation')" style="display: block; width: 392px; height: 56px; background: #0FBA68; border-radius: 8px; text-align: center; font-size: 18px; line-height: 56px; font-weight: bold; text-decoration: none; color: #FFFFFF;">
    Verify Email
    </x-mail::button>
